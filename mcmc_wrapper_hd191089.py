...
def mcmc_wrapper_hd191089(var_names = None, var_value = None, paraPath = None, calcSED = True, calcImage = True):
    """This code generates and saves the MCFOST disk(s) with given input parameters. The parameteres are modified from the template
    generated by mcfostParameterTemplate(). There are 3 major sections:
