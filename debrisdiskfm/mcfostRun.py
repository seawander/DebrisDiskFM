...
def run_hd191089(var_names = None, var_values = None, paraPath = None, calcSED = True, calcImage = True, hash_address = True, STIS = True, NICMOS = True, GPI = True, paramfiles_only = False):
